class TodoApp {
constructor() {        this.todos = [];        this.filteredTodos = [];        this.editingId = null;        this.draggedElement = null;        this.db = new TodoDatabase();        this.deadlineUpdateInterval = null;        this.currentUser = null;        this.isLoggedIn = false;        // Constants        this.ANIMATION_DELAY = 300;        this.DEADLINE_UPDATE_INTERVAL = 60000;        this.initializeAuth();    }
    }
